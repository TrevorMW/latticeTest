...
class Learndash_Memberpress_Integration
{
	...
	public function save_post_meta( $product )
	{
		...
		$new_courses = array_unique( (array) array_map( 'sanitize_text_field', $_POST['_learndash_memberpress_courses'] ) );

		$old_groups = get_post_meta( $product->rec->ID, '_learndash_memberpress_groups', true );
		$new_groups = array_unique( (array) array_map( 'sanitize_text_field', $_POST['_learndash_memberpress_groups'] ) );
